...
const context = await browser.newContext({ locale: 'vi-VN', viewport: { width: 1280, height: 900 }, colorScheme: 'dark' });
...
await page.getByRole('button', { name: /Nghe từ/ }).nth(1).click();
