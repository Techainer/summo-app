...
import { AUTO, autoAvailable, fetchLanguages, languageName, ordered, quality } from "../../lib/languages";
    ...
    <div className="border-accent/30 bg-accent-soft rounded-[var(--radius-card)] border px-3 py-2">
      <div className="text-meta flex flex-wrap items-center gap-2">
        <span className="text-fg-dim">
          ...
          {into ? ` · ${t("record.translating_into", { language: languageName(into, locale) })}` : ""}
        </span>
